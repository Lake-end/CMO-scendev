...
--- This needs refactoring: more configurable so it can be used in other scenarios (eg. configurable weather pattern, several weather zones instead of global weather)-- 0. Asetetaan varmuudeksi ensimmäisessä ajossa current day 0, HUOM vain ensimmäisellä triggeröinnillä tämä, tee erilliset EVENTit
...
if seaState >= 8 then
    advisory = "<font color='#FF4444'>DANGER: SEA STATE " ..
    seaState .. ". ALL NAVAL BASED AVIATION CEASED FOR 24H. CONVOY SPEED LIMITED DUE TO ROUGH SEAS.</font>"
elseif seaState >= 6 then
    advisory = "<font color='#FF9900'>WARNING: SEA STATE " ..
    seaState .. ". NAVAL BASED MANNED AVIATION CEASED. UAV OPS PERMITTED. CONVOY SPEED LIMITED DUE TO ROUGH SEAS.</font>"
end
